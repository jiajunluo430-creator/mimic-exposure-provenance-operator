...
All 10/10 local release checks passed. The suite ran 30 tests with 0 failures and measured 70.15% branch-aware code coverage. The wheel and sdist built successfully; a fresh virtual environment installed the wheel, resolved a bundled operator's contract/code-list/generator hashes, and reproduced the deterministic four-state demo.
